...
ANCHOR_URL = "https://www.google.com/recaptcha/api2/anchor?ar=1&k=6LcFGzUtAAAAAPp_EXvbvWrXpBgJ4tSRJoGpN98M&co=aHR0cHM6Ly9keWF4LmlvOjQ0Mw..&hl=id&v=MerVUtRoajKEbP7pLiGXkL28&size=invisible&anchor-ms=20000&execute-ms=30000&cb=nk2hkgpbzau9"

def get_recaptcha_token():
    if not PYPASSER_AVAILABLE:
        print("[!] Install PyPasser dulu: pip install PyPasser")
        return ""
    try:
